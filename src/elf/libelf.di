...
struct Elf_Arsym
{
  ...
  ulong as_hash;	/* Hash value of the name.  */
}
...
extern Elf_Kind elf_kind (Elf* __elf) pure;
...
extern deprecated int elf_getshnum (Elf* __elf, size_t* __dst);
...
/* Sun messed up the implementation of 'elf_getshnum' in their implementation.
   It was agreed to make the same functionality available under a different
   name and obsolete the old name.  */
extern deprecated int elf_getshstrndx (Elf* __elf, size_t* __dst);
...
extern uint elf_flagelf (Elf* __elf, Elf_Cmd __cmd,
				 uint __flags);
/* Similarly for the ELF header.  */
extern uint elf_flagehdr (Elf* __elf, Elf_Cmd __cmd,
				  uint __flags);
/* Similarly for the ELF program header.  */
extern uint elf_flagphdr (Elf* __elf, Elf_Cmd __cmd,
				  uint __flags);
/* Similarly for the given ELF section.  */
extern uint elf_flagscn (Elf_Scn* __scn, Elf_Cmd __cmd,
				 uint __flags);
/* Similarly for the given ELF data.  */
extern uint elf_flagdata (Elf_Data* __data, Elf_Cmd __cmd,
				  uint __flags);
/* Similarly for the given ELF section header.  */
extern uint elf_flagshdr (Elf_Scn* __scn, Elf_Cmd __cmd,
				  uint __flags);
